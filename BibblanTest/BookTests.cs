...
{    
    ...
    public class BookTests
    {
        ...
        public void AddLoanLogTest()
        {
            ...
            bool LoanLogEquals(Loanlog expected, Loanlog actual)   //Metod som kollar om LoanLogsen är 'likadana', vår tidigare override i Equals i Booksmodellen skapade nya problem med grundläggande funktioner 
            {
